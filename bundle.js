...
function (_React$Component) {
  ...
  _createClass(Clock, [{
    ...
    key: "componentWillUnmunt",
    value: function componentWillUnmunt() {
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "Clock Widget"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, this.state.date.toLocaleTimeString()));
    }
  }]);
...
function (_React$Component) {
  ...
  function Tabs(props) {
    ...
    _this.titles = _this.titles.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.content = _this.content.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.updateTab = _this.updateTab.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }

  _createClass(Tabs, [{
    key: "updateTab",
    value: function updateTab(e, index) {
      e.preventDefault();
      this.setState({
        index: index
      });
    ...
    value: function content() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, this.props.tabs[this.state.index].content);
    }
  }, {
    key: "render",
    value: function render() {
...
function (_React$Component) {
  ...
  _createClass(Root, [{
    ...
    value: function render() {
      var tabs = [{
        title: "shopping list",
        content: "bananas, cereal, milk, bacon"
      }, {
        title: "best horror movies",
        content: "get out, the wailing, the witch"
      }];
